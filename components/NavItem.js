    ...
    >
      {({ open }) => (
        <>
          ...
          >
            <Popover.Panel className='absolute left-0 z-10  w-screen max-w-xs  sm:px-0 lg:max-w-3xl'>
              <div className='w-fit max-w-lg overflow-hidden rounded-xl shadow-xl ring-1 ring-gray-500 ring-opacity-30'>
                <div className='relative grid gap-x-10 bg-white px-12 py-8  lg:grid-flow-col'>
                  {children}
                </div>
              </div>
            </Popover.Panel>
