...
const RequestDemo = ({ model }) => {
  ...
  return (
    <div className='relative overflow-hidden bg-primaryBrand'>
      <div
        className={`absolute  ${
          model
            ...
            : 'bottom-0 -right-1/4 h-[50vh] w-screen sm:-right-1/4 sm:-bottom-1/4 sm:h-[70vh] md:-right-1/3 md:h-[80vh]  md:w-fit lg:-right-0 lg:-bottom-0 lg:w-[50vw]'
        }  `}
      >
        <div
          className={`relative aspect-square z-0${
            model
              ? '-left-6 h-[70vh] w-[70vh] 2xl:-bottom-1/4'
              : ' bottom-0 right-0 h-[50vh] w-screen sm:right-0 md:top-0 md:h-[70vh] lg:h-[90vh] lg:w-fit'
          }`}
        >
          <Image
      ...
      <Layout>
        <div className=' z-50 flex min-h-[80vh] flex-col px-8 sm:py-12 lg:flex-row lg:px-12'>
